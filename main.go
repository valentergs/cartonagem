...
func main() {
	...
	// fmt.Println("-----------")
	// fmt.Printf("Base: %vcm x %vcm\n", largura, comprimento)
	// fmt.Printf("Lateral Esquerda: %vcm x %vcm\n", comprimento, altura)
	// fmt.Printf("Lateral Direita: %vcm x %vcm\n", comprimento, altura)
	// fmt.Printf("Lateral Frente: %vcm x %vcm\n", (largura + espessura), altura)
	// fmt.Printf("Lateral Fundo: %vcm x %vcm\n", (largura + espessura), altura)
	// fmt.Printf("Tampa: %vcm x %vcm\n", (largura + 1.5), (comprimento + 1))
	// fmt.Printf("Fundo: %vcm x %vcm\n", (largura + 1.5), (comprimento + 1))
	// fmt.Printf("Lombada: %vcm x %vcm\n", (largura + 1.5), altura)
	// fmt.Printf("Interno Tampa: %vcm x %vcm\n", (largura + 1.5 - 0.5), (comprimento + 1 - 0.5))
	// fmt.Printf("Externo Lateral Direita: %vcm x %vcm\n", (comprimento + espessura), (altura - 0.1))
	// fmt.Printf("Externo Lateral Esquerda: %vcm x %vcm\n", (comprimento + espessura), (altura - 0.1))
	// fmt.Printf("Externo Lateral Frente: %.1fcm x %vcm\n", ((comprimento + espessura) - 0.1), (altura - 0.1))
	// fmt.Printf("Externo Lateral Fundo: %.1fcm x %vcm\n", ((comprimento + espessura) - 0.1), (altura - 0.1))
}
